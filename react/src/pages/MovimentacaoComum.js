...
const estilos = {
	...
	inputPrincipal: tailwind("border border-green-400 rounded font-bold text-4xl py-6 px-20 mb-16 text-gray-700 text base max-w-xs"),
	...
	labelInputcategoria: tailwind("text-gray-700 text-base font-bold mb-3 mr-40 ml-8"),

	botaoAdicionar: tailwind("bg-green-400 py-2 rounded w-32 mb-8 mr-1 mt-12 ml-16"),
